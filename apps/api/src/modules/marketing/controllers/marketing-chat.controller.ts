...
import { MarketingChatTargetsQueryDto } from "../dto/marketing-chat.dto";
...
export class MarketingChatController {
  ...
  @RequirePermissions("chat.read")
  searchEmployees(@Query() query: MarketingChatTargetsQueryDto) {
    return this.crmChatService.searchEmployees(query.search ?? "", query.limit ?? 6);
  }

  @Get("targets/clients")
  @RequirePermissions("chat.read")
  searchClients(@Query() query: MarketingChatTargetsQueryDto) {
