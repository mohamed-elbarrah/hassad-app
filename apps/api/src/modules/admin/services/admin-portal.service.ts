  ...
  async getIntakeForms(query: {
    ...
    return {
      items: items.map((f) => ({
        ...
        communicationInfo: f.communicationInfo,
        productInfo: f.productInfo,
        audienceInfo: f.audienceInfo,
        brandVoice: f.brandVoice,
        customerJourney: f.customerJourney,
        campaignInfo: f.campaignInfo,
        pastPerformance: f.pastPerformance,
        budgetInfo: f.budgetInfo,
        visualIdentityInfo: f.visualIdentityInfo,
