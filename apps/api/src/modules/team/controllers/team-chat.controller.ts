...
import { TeamChatTargetsQueryDto } from "../dto/team-chat.dto";
...
export class TeamChatController {
  constructor(
    ...
    private readonly crmChatService: TeamChatService,
  ) {}
  ...
  @RequirePermissions("chat.read")
  searchEmployees(@Query() query: TeamChatTargetsQueryDto) {
    return this.crmChatService.searchEmployees(query.search ?? "", query.limit ?? 6);
  }

  @Get("targets/clients")
  @RequirePermissions("chat.read")
  searchClients(@Query() query: TeamChatTargetsQueryDto) {
