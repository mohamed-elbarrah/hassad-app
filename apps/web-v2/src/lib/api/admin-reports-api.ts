...
export const adminReportsApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getAdminRequestsReport: builder.query<unknown, AdminReportQuery | void>({ query: (params) => ({ url: "/admin/reports/requests", params: params ?? undefined }), providesTags: ["AdminReports"] }),
...
export const {
  ...
  useGetAdminRequestsReportQuery,
