...
export function translateRequestLabel(locale: Locale, value: string): string {
  ...
  if (value.startsWith("Signed ")) return `تم التوقيع ${value.slice(7)}`;
