...
export function PortalEmptyState({ icon: Icon, title, description, actionLabel, onAction }: PortalEmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      ...
      {description && <p className="text-sm text-portal-note-text mb-4">{description}</p>}
