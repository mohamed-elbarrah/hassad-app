  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: cn(
          "flex min-w-[17.5rem] flex-col gap-4",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        defaultClassNames.day,
        modifiers.outside &&
          "bg-transparent text-muted-foreground data-[range-middle=true]:bg-transparent data-[range-start=true]:bg-transparent data-[range-end=true]:bg-transparent",
        className
      )}
      {...props}
    />
