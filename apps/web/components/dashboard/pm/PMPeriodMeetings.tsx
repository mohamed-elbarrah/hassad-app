...
const inputClass =
  "flex h-10 w-full rounded-xl border border-neutral-200 bg-white px-3 py-2 text-sm text-secondary-500 placeholder:text-neutral-200 focus:outline-none focus:border-secondary-500 focus:ring-1 focus:ring-secondary-500/20 transition-colors text-right";
...
function CreateMeetingForm({
  ...
  return (
    <div className="space-y-3 rounded-xl border border-neutral-200 bg-white p-4" dir="rtl">
      <FormInputControl
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <p className={cn("text-sm font-medium text-natural-100", cancelled && "text-neutral-400 line-through")}>
                {meeting.title}
              </p>
            ...
            {meeting.notes && (
              <p className="mt-2 whitespace-pre-line rounded-lg bg-neutral-50 p-2 text-xs leading-5 text-neutral-500">
                {meeting.notes}
              </p>
            )}
          </div>
      ...
      {showNotes && (
        <div className="mt-3 space-y-2 rounded-lg bg-neutral-50 p-3">
          <textarea
            ...
            rows={3}
            className="w-full resize-none rounded-lg border border-neutral-200 bg-white p-2 text-sm focus:outline-none focus:border-secondary-500"
          />
          <div className="flex justify-end gap-2">
