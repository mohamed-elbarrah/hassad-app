...
import { DashboardNotificationsDropdown } from "./DashboardNotificationsDropdown";
...
export function DashboardNotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        className="relative flex items-center justify-center shrink-0 bg-white cursor-pointer"
        style={{
          width: 56,
          height: 56,
      ...
      {isDropdownOpen && <DashboardNotificationsDropdown />}
    </div>
  );
}
