...
export interface NotificationDropdownProps {
  ...
  getActionLabel: (entityType: string | null | undefined) => string;
...
export function NotificationDropdown({
  ...
  const [selectedNotification, setSelectedNotification] =
    useState<NotificationItemBase | null>(null);

  async function handleSelect(notification: NotificationItemBase) {
  ...
  const entityUrl = selectedNotification
    ? resolveUrl(selectedNotification.entityType, selectedNotification.entityId)
    : null;
            ...
            <div className="flex flex-row-reverse gap-2 p-5 pt-0">
              {entityUrl && (
                ...
                >
                  ...
                  {getActionLabel(selectedNotification.entityType)}
                </button>
              )}
              <button
