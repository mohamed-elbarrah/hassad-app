...
export function DeliverableItem({
  ...
  return (
    <div className="flex items-start justify-between p-4 bg-white border-[1.5px] border-portal-card-border rounded-card-sm">
      <div className="flex-1 min-w-0 text-right">
        <h4 className="text-[20px] font-semibold leading-[30px] text-natural-100 truncate">
          {title}
        </h4>
        <p className="mt-1 text-base leading-[22px] text-portal-note-text line-clamp-1">
          {description}
        </p>
