...
export default function MarketingDashboardPage() {
  ...
  const totalActiveTasks = marketingTasks.filter(
                  ...
                  <div className="group p-4 rounded-xl border border-neutral-50/50 hover:border-secondary-500/40 hover:bg-neutral-50/5 transition-all mb-3 cursor-pointer">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-2 h-2 rounded-full ${task.status === "IN_PROGRESS" ? "bg-success-500 animate-pulse" : "bg-neutral-300"}`}
                        />
                        <h4 className="font-bold group-hover:text-secondary-500 transition-colors">
                          {task.title}
                        </h4>
                      </div>
                      <Pill
