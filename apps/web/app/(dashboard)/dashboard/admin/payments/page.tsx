    ...
    <div className="space-y-6 p-6 pb-16">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-neutral-300">
          تكوين بوابات الدفع والحسابات البنكية لاستقبال المدفوعات من العملاء
        </p>
      </div>
            ...
            {bankAccounts?.map((account) => (
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    <div className="text-[10px] text-neutral-300 uppercase tracking-wider mb-1">
                      اسم الحساب
                    </div>
            ...
            {bankAccounts?.length === 0 && (
              <div className="col-span-full py-12 flex flex-col items-center justify-center text-neutral-300 border-2 border-dashed rounded-xl">
                ...
                <ActionButton
                  variant="outline"
                  onClick={() =>
                    document.getElementById("add-bank-trigger")?.click()
                  }
                >
                  إضافة أول حساب الآن
                </ActionButton>
