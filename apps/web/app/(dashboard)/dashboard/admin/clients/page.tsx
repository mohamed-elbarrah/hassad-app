...
function LoadingState() {
  return (
    <div className="flex flex-col gap-6" dir="rtl">
      <PageHeader
        title="العملاء"
        description="جارٍ تحميل بيانات العملاء."
        icon={Users}
      />
...
export default function ClientsPage() {
  ...
  const query = useGetAdminClientsQuery({
          ...
          <CardContent className="p-8">
            <Empty>
              ...
              <EmptyHeader>
                ...
                <EmptyDescription>
                  {adminErrorMessage(query.error ?? statsQuery.error)}
                </EmptyDescription>
              </EmptyHeader>
              <EmptyContent>
                <Button
  ...
  return (
    <div className="flex flex-col gap-6" dir="rtl">
      <PageHeader
        title="العملاء"
        description="إدارة حسابات العملاء ومتابعة نشاطهم المالي والتشغيلي."
        icon={Building2}
        actions={
          <div className="flex flex-wrap gap-2">
            ...
            >
              ...
              {query.isFetching ? "جاري التحديث" : "تحديث"}
            </Button>
            <Button onClick={() => setCreateOpen(true)}>إضافة عميل</Button>
          </div>
        }
      />
        ...
        <div className="grid max-w-3xl gap-3 md:grid-cols-[minmax(0,1fr)_220px]">
          <div className="relative">
            ...
            <Input
              ...
              placeholder="ابحث باسم العميل أو الشركة أو المدير"
              className="pr-10"
            />
          </div>
          <Select
            value={filter}
            onValueChange={(value) => {
              setFilter(value as ClientFilter);
              setPage(1);
            }}
          >
            <SelectTrigger
            ...
            <SelectContent>
              ...
              <SelectItem value="active">
                {statusLabel(ClientStatus.ACTIVE)}
              </SelectItem>
              <SelectItem value="stopped">
                {statusLabel(ClientStatus.SUSPENDED)}
              </SelectItem>
              ...
              <TableBody>
                {clients.map((client) => (
                  <TableRow key={client.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant={client.isActive ? "secondary" : "destructive"}
                      >
                    ...
                    <TableCell>
                      <div className="flex flex-col gap-1">
                        <span>{formatNumber(client.projectsCount)}</span>
                        <span className="text-xs text-muted-foreground">
                          {formatNumber(client.activeProjects)} نشط
                        </span>
                      </div>
                    </TableCell>
                    ...
                    <TableCell>
                      <Badge
                        variant={client.portalAccess ? "secondary" : "outline"}
                      >
