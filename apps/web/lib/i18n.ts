...
const ADMIN_ERROR_MESSAGES: Record<string, string> = {
  ...
  USER_ALREADY_ACTIVE: "الموظف نشط بالفعل.",
  USER_ALREADY_INACTIVE: "الموظف غير نشط بالفعل.",
  CLIENT_ALREADY_ACTIVE: "حساب العميل نشط بالفعل.",
  CLIENT_ALREADY_INACTIVE: "حساب العميل غير نشط بالفعل.",
  CLIENT_ACCOUNT_NOT_FOUND: "لا يوجد حساب دخول مرتبط بهذا العميل.",
  CLIENT_ALREADY_SUSPENDED: "العميل موقوف بالفعل.",
  CLIENT_NOT_SUSPENDED: "العميل غير موقوف.",
  SELF_ACCOUNT_ACTION_FORBIDDEN: "لا يمكنك تغيير حالة حسابك.",
  LAST_ADMIN_PROTECTED: "لا يمكن تعطيل آخر حساب مدير نشط.",
  ACCOUNT_ACTION_FORBIDDEN: "لا يسمح بتنفيذ هذا الإجراء على الحساب.",
  ...
  SERVICE_INACTIVE: "الخدمة المحددة غير متاحة حالياً.",
  DUPLICATE_REQUEST_SERVICE: "لا يمكن إضافة الخدمة نفسها أكثر من مرة.",
  INVALID_SERVICE_QUANTITY: "كمية الخدمة غير صالحة.",
  DELIVERABLE_TEMPLATE_NOT_FOUND: "لم يتم العثور على قالب التسليم.",
  PERMISSION_DENIED: "ليس لديك صلاحية لتنفيذ هذا الإجراء.",
  VALIDATION_ERROR: "تحقق من البيانات المدخلة وحاول مرة أخرى.",
  ...
  INTEGRATION_SETTINGS_LOAD_FAILED: "تعذر تحميل إعدادات التكاملات.",
  INTEGRATION_SETTINGS_UPDATE_FAILED: "تعذر حفظ إعدادات التكاملات.",
  R2_TEST_FAILED: "تعذر اختبار اتصال التخزين.",
  R2_CONNECTION_FAILED: "تعذر الاتصال بتخزين الملفات.",
  R2_AUTHENTICATION_FAILED: "بيانات اعتماد Cloudflare R2 غير صحيحة.",
  R2_BUCKET_NOT_FOUND: "تعذر العثور على حاوية Cloudflare R2.",
  R2_CONNECTION_UNAVAILABLE: "تعذر الوصول إلى خدمة Cloudflare R2.",
  R2_CONFIGURATION_INCOMPLETE: "أكمل إعدادات تخزين الملفات أولاً.",
  ...
  UNSAFE_R2_ENDPOINT: "نقطة اتصال التخزين غير مسموحة.",
  INVALID_R2_BUCKET: "اسم الحاوية غير صالح.",
  SETTINGS_ENCRYPTION_KEY_REQUIRED: "لا يمكن حفظ المفاتيح بأمان حالياً.",
  SETTINGS_ENCRYPTION_KEY_MISSING: "إعداد تشفير المفاتيح غير متاح حالياً.",
  SETTINGS_ENCRYPTION_KEY_INVALID: "إعداد تشفير المفاتيح غير صالح.",
  UNKNOWN_ERROR: "حدث خطأ. يرجى المحاولة مرة أخرى.",
};
...
const ADMIN_SUCCESS_MESSAGES: Record<string, string> = {
  ...
  USER_SUSPENDED: "تم إيقاف حساب الموظف.",
  USER_REACTIVATED: "تمت إعادة تفعيل حساب الموظف.",
  CLIENT_ACTIVATED: "تم تفعيل حساب العميل.",
  CLIENT_DEACTIVATED: "تم تعطيل حساب العميل.",
  CLIENT_SUSPENDED: "تم إيقاف العميل.",
  CLIENT_REACTIVATED: "تمت إعادة تفعيل العميل.",
  ...
  INTEGRATION_SETTINGS_UPDATED: "تم حفظ إعدادات التكاملات.",
  SERVICE_CREATED: "تم إنشاء الخدمة بنجاح.",
  SERVICE_UPDATED: "تم تحديث الخدمة بنجاح.",
  SERVICE_ARCHIVED: "تمت أرشفة الخدمة.",
  SERVICE_RESTORED: "تمت استعادة الخدمة.",
  R2_TEST_SUCCEEDED: "اتصال التخزين يعمل بنجاح.",
  R2_CONNECTION_SUCCESS: "اتصال التخزين يعمل بنجاح.",
...
export function portalErrorMessage(error: unknown): string {
  ...
  const messages: Record<string, string> = {
    ...
    INVOICE_ALREADY_PAID: "هذه الفاتورة مدفوعة بالفعل.",
    INVOICE_NOT_PAYABLE: "لا يمكن اعتماد دفعة لهذه الفاتورة حالياً.",
    INVOICE_ACCESS_FORBIDDEN: "ليس لديك صلاحية الوصول إلى هذه الفاتورة.",
    BANK_TRANSFER_UNAVAILABLE: "التحويل البنكي غير متاح حالياً.",
    PAYMENT_NOT_FOUND: "لم يتم العثور على عملية الدفع.",
    PAYMENT_ID_REQUIRED: "معرّف عملية الدفع مطلوب.",
    PAYMENT_REVIEW_NOT_SUPPORTED: "لا يمكن مراجعة طريقة الدفع هذه.",
    PAYMENT_ALREADY_REVIEWED: "تمت مراجعة عملية الدفع مسبقاً.",
    PAYMENT_REVIEW_CONFLICT:
      "تغيرت حالة الدفع أثناء المراجعة. حدّث البيانات وحاول مرة أخرى.",
    PAYMENT_PENDING_REVIEW: "توجد دفعة معلقة لهذه الفاتورة وتنتظر المراجعة.",
    PAYMENT_RECEIPT_REQUIRED: "يجب إرفاق إيصال التحويل قبل المراجعة.",
    PAYMENT_RECEIPT_NOT_ALLOWED: "لا يمكن إرفاق إيصال بهذه العملية.",
    PAYMENT_RECEIPT_ALREADY_ATTACHED: "تم إرفاق إيصال بهذه العملية مسبقاً.",
    PAYMENT_CURRENCY_MISMATCH: "عملة الدفع لا تطابق عملة الفاتورة.",
    PAYMENT_GATEWAY_NOT_CONFIGURED: "بوابة الدفع غير مهيأة حالياً.",
    ...
    WEBHOOK_RETRY_FAILED: "تعذر إعادة معالجة العملية.",
    WEBHOOK_SIGNATURE_REQUIRED: "توقيع العملية مطلوب.",
    WEBHOOK_PROVIDER_UNSUPPORTED: "مزود العملية غير مدعوم.",
    PAYMENT_ELEMENT_NOT_SUPPORTED: "طريقة الدفع هذه غير مدعومة حالياً.",
    PAYMENT_CHECKOUT_URL_MISSING: "تعذر تجهيز رابط الدفع.",
    PAYMENT_PROVIDER_UNAVAILABLE: "بوابة الدفع غير متاحة حالياً.",
    PAYMENT_PROVIDER_REQUEST_FAILED: "تعذر إنشاء عملية الدفع.",
    PAYMENT_PROVIDER_RESPONSE_INVALID: "استجابة بوابة الدفع غير صالحة.",
    PAYMENT_CUSTOMER_DETAILS_REQUIRED: "بيانات العميل غير مكتملة للدفع.",
    PAYMENT_STATUS_NOT_SUPPORTED: "تعذر التحقق من حالة الدفع.",
    PAYMENT_PROVIDER_AMOUNT_MISSING: "لم يتم التحقق من مبلغ الدفع من المزود.",
    PAYMENT_PROVIDER_AMOUNT_MISMATCH: "مبلغ الدفع لا يطابق بيانات الفاتورة.",
    PAYMENT_AMOUNT_PRECISION_INVALID: "دقة مبلغ الدفع لا تطابق عملة الفاتورة.",
    PAYMENT_FORM_NOT_READY: "نموذج الدفع غير جاهز حالياً.",
    STRIPE_PAYMENT_FAILED: "تعذر إتمام الدفع عبر البطاقة.",
    PAYMENT_AMOUNT_INVALID: "مبلغ الدفع غير صالح.",
    PAYMENT_AMOUNT_EXCEEDS_REMAINING: "مبلغ الدفع أكبر من المبلغ المتبقي.",
    REJECTION_REASON_REQUIRED: "يجب إدخال سبب الرفض.",
    FILE_REQUIRED: "يجب إرفاق الملف.",
  };
  return (
