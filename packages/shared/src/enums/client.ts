...
export enum NotificationEventType {
  ...
  MARKETING_STRATEGY_APPROVED = "MARKETING_STRATEGY_APPROVED",
  MARKETING_STRATEGY_REJECTED = "MARKETING_STRATEGY_REJECTED",
  MARKETING_STRATEGY_REVISION_REQUESTED = "MARKETING_STRATEGY_REVISION_REQUESTED",
  MARKETING_STRATEGY_SENT = "MARKETING_STRATEGY_SENT",
  // Chat
